...
program
	...
	.command(
		...
		"start local fruster defined by service registry"
	)
	.alias("run")
	.command(
	...
	.command(
		...
		"fetch services defined in service registry"
	)
	...
	.command(
		...
		"create apps defined in service registry"
	)
	.command(
		"destroy-apps <registry>",
		"destroy apps defined in service registry"
	)
