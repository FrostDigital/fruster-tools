...
program
  ...
  .command("start-box <service-registry> <image>", "start fruster defined by service registry using an existing docker image where all services and dependencies exists").alias("run-box")
